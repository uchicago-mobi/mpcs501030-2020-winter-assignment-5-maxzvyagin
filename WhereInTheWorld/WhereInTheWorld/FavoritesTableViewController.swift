...
class FavoritesTableViewController: UITableViewController {
    ...
    // source: https://stackoverflow.com/questions/56874166/swift-how-to-dismiss-a-viewcontroller-programmatically
    @IBAction func dismissTable(_ sender: Any) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        // send the name of the place to center on and dismiss the table view
